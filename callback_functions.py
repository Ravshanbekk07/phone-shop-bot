...
def start(update: Update, context: CallbackContext) -> None:
    ...
    db.add_user(update.message.chat.id,update.message.chat.first_name,update.message.chat.username)
...
def brands(update: Update, context: CallbackContext):
    ...
    # for btn in inline_keyboards:
    #     if btn!=inline_keyboards[0][0]:
...
def send_product_detail(update: Update, context: CallbackContext):
    ...
    btn1 = InlineKeyboardButton(text='add cart', callback_data=f'add-cart:{product_id}')
